...
class Settings(BaseSettings):
    ...
    minio_access_key: str = Field(default='admin', description="Access key for Minio server")
    minio_secret_key: str = Field(default='computer12345', description="Secret key for Minio server")
